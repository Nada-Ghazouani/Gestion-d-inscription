    ...
    <div class="bloc_page">
        ...
        <center>
    		...
    		<form method="POST" action="modifier.php">
                ...
                <input type="text" name="matricule" id="matricule" placeholder="" size="80%" autofocus required maxlength="20"><br/><br>

    			<label for="nom" class="identifie"> Nom* </label><br>
                <input type="text" name="nom" id="nom" placeholder=""size="80%" required><br/><br>

    			<label for="prenom" class="identifie"> Prenom* </label> <br>
                <input type="text" name="prenom" id="prenom" placeholder=""size="80%" required><br/><br>

    			<label for="email" class="identifie"> Email </label><br>
                <input type="email" name="email" id="email"placeholder=""size="80%"><br/><br>

    			<label for="telephone" class="identifie">Téléphone </label><br>
                <input type="tel" name="telephone" id="telephone" placeholder="" size="80%" required><br/><br>
    		   ...
    		   <div>
    			...
    			<div class="liste">
        			...
        			<select name="niveau" id="niveau">
        				...
        				<option value="5"> Master 2 </option>n>
        			</select>
                </div>
